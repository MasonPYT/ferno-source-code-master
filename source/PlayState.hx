...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'fury':
				dialogue = CoolUtil.coolTextFile(Paths.txt('fury/dialog'));
		}
		...
		switch(stageCheck)
		{
			...
			case 'hell':
			{
					defaultCamZoom = 0.9;
					curStage = 'hell';
					var bg:FlxSprite = new FlxSprite(-230, -100).loadGraphic(Paths.image('hell/lowkeythedevilvibespot'));
					bg.antialiasing = true;
			...
			case 'koolaidhell':
			{
					defaultCamZoom = 0.9;
					curStage = 'stage';
					var bg:FlxSprite = new FlxSprite(-230, -100).loadGraphic(Paths.image('koolaidhell/themanspiltthekoolaid'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);
		...
		healthBar.createFilledBar(0xFFFFA500, 0xFF00BFFF);
		// healthBar
		add(healthBar);
